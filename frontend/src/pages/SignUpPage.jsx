    ...
    return (
        <VStack>
            ...
            <Input
                ...
                onChange={(e) => setUserData({ ...userData, username:  e.target.value.trim(), userid:  e.target.value.trim() })}
            />
            <PasswordInput
                size={{base: "md", md:"xl"}}
    ...
    return (
        <VStack w={"full"}>
            ...
            <Input
                ...
                onChange={(e) => setUserData({ ...userData, instagram: e.target.value.trim() })}
            />
        </VStack>
    )
}
...
export const validatePasswordForm = (userData, tempData) => {
    ...
    if (!validatePassword(userData.password)) {
        showError("Invalid password format (at least 8 characters, 1 uppercase, 1 lowercase, 1 number and 1 special character)");
        return false;
    }
    return true;
}
